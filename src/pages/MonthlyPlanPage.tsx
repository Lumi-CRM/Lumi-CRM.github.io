...
const MonthlyPlanPage = () => {
  ...
  return <div className="min-w-0 space-y-6 pb-10">
    ...
    {loading ? <p className="lumi-muted py-12 text-center">Загружаем план…</p> : <div className="grid gap-4 lg:grid-cols-2">{METRICS.map(([key, label, unit]) => {
